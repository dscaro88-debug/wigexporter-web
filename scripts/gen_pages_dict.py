...
T = {
    ...
    # ---- New: customization, colour chart, synthetic-25 product configurator pages ----
    "selected": ("SELECCIONADO", "AUSGEWÄHLT", "SÉLECTIONNÉ"),
    "request to confirm": ("SOLICITAR CONFIRMACIÓN", "BESTÄTIGUNG ANFRAGEN", "DEMANDER CONFIRMATION"),
    "discuss this product →": ("HABLAR DE ESTE PRODUCTO →", "DIESES PRODUKT BESPRECHEN →", "DISCUTER CE PRODUIT →"),
    "reference attachment": ("Adjunto de referencia", "Referenz-Anhang", "Pièce jointe de référence"),
    "reference documented": ("REFERENCIA DOCUMENTADA", "REFERENZ DOKUMENTIERT", "RÉFÉRENCE DOCUMENTÉE"),
    "published imagery": ("Imágenes publicadas", "Veröffentlichte Bilder", "Imagerie publiée"),
    "buyer questions": ("PREGUNTAS DEL COMPRADOR", "KÄUFERFRAGEN", "QUESTIONS ACHETEURS"),
    "your requested specification": ("SU ESPECIFICACIÓN SOLICITADA", "IHRE ANGEFRAGTE SPEZIFIKATION", "VOTRE SPÉCIFICATION DEMANDÉE"),
    "your development brief": ("SU BRIEF DE DESARROLLO", "IHR ENTWICKLUNGSBRIEF", "VOTRE BRIEF DE DÉVELOPPEMENT"),
    "send this development brief": ("ENVIAR ESTE BRIEF DE DESARROLLO", "DIESEN ENTWICKLUNGSBRIEF SENDEN", "ENVOYER CE BRIEF DE DÉVELOPPEMENT"),
    "send this specification": ("ENVIAR ESTA ESPECIFICACIÓN", "DIESE SPEZIFIKATION SENDEN", "ENVOYER CETTE SPÉCIFICATION"),
    "build your buying brief": ("CONSTRUIR SU BRIEF DE COMPRA", "IHREN KÄUFERBRIEF ERSTELLEN", "CONSTRUIRE VOTRE BRIEF D'ACHAT"),
    "build your colour & packaging brief": ("CONSTRUIR SU BRIEF DE COLOR Y EMPAQUE", "FARB- UND VERPACKUNGSBRIEF ERSTELLEN", "CONSTRUIRE VOTRE BRIEF COULEUR ET EMBALLAGE"),
    "request colour kit support": ("SOLICITAR SOPORTE DE KIT DE COLOR", "FARBSET-SUPPORT ANFRAGEN", "DEMANDER SUPPORT KIT COULEUR"),
    "request specification": ("SOLICITAR ESPECIFICACIÓN", "SPEZIFIKATION ANFRAGEN", "DEMANDER UNE SPÉCIFICATION"),
    "discuss a sample": ("HABLAR DE UNA MUESTRA", "EIN MUSTER BESPRECHEN", "DISCUTER UN ÉCHANTILLON"),
    "clear selections": ("BORRAR SELECCIONES", "AUSWAHL LÖSCHEN", "EFFACER LES SÉLECTIONS"),
    "start project": ("INICIAR PROYECTO", "PROJEKT STARTEN", "DÉMARRER LE PROJET"),
    "current shortlist": ("LISTA CORTA ACTUAL", "AKTUELLE AUSWAHL", "SÉLECTION ACTUELLE"),
    "colour & packaging studio": ("ESTUDIO DE COLOR Y EMPAQUE", "FARB- UND VERPACKUNGSSTUDIO", "STUDIO COULEUR ET EMBALLAGE"),
    "open the colour & packaging studio": ("ABRIR EL ESTUDIO DE COLOR Y EMPAQUE", "FARB- UND VERPACKUNGSSTUDIO ÖFFNEN", "OUVRIR LE STUDIO COULEUR ET EMBALLAGE"),
    "colour & packaging": ("COLOR Y EMPAQUE", "FARBE UND VERPACKUNG", "COULEUR ET EMBALLAGE"),
    "colour and packaging development summary": ("Resumen de desarrollo de color y empaque", "Zusammenfassung Farb- und Verpackungsentwicklung", "Résumé développement couleur et emballage"),
    "build a brief": ("CREAR UN BRIEF", "BRIEF ERSTELLEN", "CRÉER UN BRIEF"),
    "select a colour chart 2 shade": ("Seleccionar un tono de la Carta de Color 2", "Wählen Sie einen Colour Chart 2-Ton", "Sélectionner une nuance du Nuancier 2"),
    "filter by colour family": ("Filtrar por familia de color", "Nach Farbfamilie filtern", "Filtrer par famille de couleur"),
    "browse all 31 colours →": ("Ver los 31 tonos →", "Alle 31 Nuancen durchsuchen →", "Parcourir les 31 nuances →"),
    "explore 31 colours": ("EXPLORAR 31 TONOS", "31 NUANCEN ENTDECKEN", "EXPLORER 31 NUANCES"),
    "31 colours. one clearer starting point.": ("31 tonos. Un punto de partida más claro.", "31 Nuancen. Ein klarerer Ausgangspunkt.", "31 nuances. Un point de départ plus clair."),
    "start with a shortlist. approve before scale.": ("Empiece con una lista corta. Apruebe antes de escalar.", "Beginnen Sie mit einer Auswahl. Freigabe vor Hochskalierung.", "Commencez par une sélection. Approuvez avant de passer à l'échelle."),
    "01 · shade shortlist": ("01 · LISTA CORTA DE TONOS", "01 · FARBAUSWAHL", "01 · SÉLECTION DE NUANCES"),
    "02 · physical reference": ("02 · REFERENCIA FÍSICA", "02 · PHYSISCHE REFERENZ", "02 · RÉFÉRENCE PHYSIQUE"),
    "03 · packaging structure": ("03 · ESTRUCTURA DE EMPAQUE", "03 · VERPACKUNGSSTRUKTUR", "03 · STRUCTURE D'EMBALLAGE"),
    "04 · logo application": ("04 · APLICACIÓN DE LOGO", "04 · LOGO-ANWENDUNG", "04 · APPLICATION DU LOGO"),
    "05 · approval path": ("05 · RUTA DE APROBACIÓN", "05 · FREIGABEWEG", "05 · PARCOURS D'APPROBATION"),
    "01 · starter identity": ("01 · IDENTIDAD INICIAL", "01 · STARTER-IDENTITÄT", "01 · IDENTITÉ DE DÉMARRAGE"),
    "02 · retail ready": ("02 · LISTO PARA VENTA", "02 · RETAIL READY", "02 · PRÊT POUR LA VENTE"),
    "03 · bespoke programme": ("03 · PROGRAMA A MEDIDA", "03 · MAßGESCHNEIDERTES PROGRAMM", "03 · PROGRAMME SUR MESURE"),
    "similar product comparison": ("COMPARACIÓN DE PRODUCTOS SIMILARES", "ÄHNLICHE PRODUKTVERGLEICHE", "COMPARAISON DE PRODUITS SIMILAIRES"),
    "related development directions": ("DIRECCIONES DE DESARROLLO RELACIONADAS", "VERWANDTE ENTWICKLUNGSRICHTUNGEN", "DIRECTIONS DE DÉVELOPPEMENT LIÉES"),
    "professional product knowledge": ("CONOCIMIENTO PROFESIONAL DEL PRODUCTO", "PROFESSIONELLE PRODUKTkenntnis", "CONNAISSANCE PROFESSIONNELLE DU PRODUIT"),
    "the ds hair difference": ("LA DIFERENCIA DS HAIR", "DER DS HAIR-UNTERSCHIED", "LA DIFFÉRENCE DS HAIR"),
    "evaluation points": ("PUNTOS DE EVALUACIÓN", "BEWERTUNGSPUNKTE", "POINTS D'ÉVALUATION"),
    "approval process": ("PROCESO DE APROBACIÓN", "FREIGABEPROZESS", "PROCESSUS D'APPROBATION"),
    "reference shown": ("REFERENCIA MOSTRADA", "GEZEIGTE REFERENZ", "RÉFÉRENCE AFFICHÉE"),
    "confirmed facts, clearly separated from open items.": ("Hechos confirmados, claramente separados de puntos abiertos.", "Bestätigte Fakten, klar von offenen Punkten getrennt.", "Faits confirmés, clairement séparés des points ouverts."),
    "commercial values separated from the product record": ("Valores comerciales separados del registro de producto", "Kommerzielle Werte vom Produktrecord getrennt", "Valeurs commerciales séparées de la fiche produit"),
    "this page prepares an enquiry. it does not indicate live stock, confirmed moq, price or production feasibility.": ("Esta página prepara una consulta. No indica stock, MOQ, precio o viabilidad de producción confirmados.", "Diese Seite bereitet eine Anfrage vor. Sie zeigt keinen Live-Bestand, bestätigte MOQ, Preis oder Produktionsmachbarkeit.", "Cette page prépare une demande. Elle n'indique pas de stock, de MOQ, de prix ou de faisabilité de production confirmés."),
    "build your brief →": ("Cree su brief →", "Erstellen Sie Ihren Brief →", "Créez votre brief →"),
    "what your team should verify.": ("Lo que su equipo debe verificar.", "Was Ihr Team überprüfen sollte.", "Ce que votre équipe doit vérifier."),
    "what is this product for?": ("¿Para qué es este producto?", "Wofür ist dieses Produkt?", "À quoi sert ce produit ?"),
    "what is a wrap-around synthetic ponytail?": ("¿Qué es una cola de caballo sintética wrap-around?", "Was ist ein Wrap-Around-Synthetik-Pferdeschwanz?", "Qu'est-ce qu'une queue de cheval synthétique wrap-around ?"),
    "is this 25-inch straight synthetic ponytail available for wholesale and private label?": ("¿Esta cola de caballo sintética lisa de 25 in está disponible para mayorista y marca privada?", "Ist dieser 25-Zoll glatte Synthetik-Pferdeschwanz für Großhandel und Eigenmarke verfügbar?", "Cette queue de cheval synthétique lisse de 25 in est-elle disponible en gros et en marque privée ?"),
    "how does the reference ponytail attach?": ("¿Cómo se fija la cola de caballo de referencia?", "Wie wird der Referenz-Pferdeschwanz befestigt?", "Comment s'attache la queue de cheval de référence ?"),
    "what length and finish are documented?": ("¿Qué longitud y acabado están documentados?", "Welche Länge und Finish sind dokumentiert?", "Quelle longueur et finition sont documentées ?"),
    "what should buyers verify at 25 inches?": ("¿Qué deben verificar los compradores a 25 in?", "Was sollten Käufer bei 25 Zoll überprüfen?", "Que doivent vérifier les acheteurs à 25 in ?"),
    "why use a rear-view before/after image?": ("¿Por qué usar una imagen trasera antes/después?", "Warum ein Vorher/Nachher-Rückansichtsbild verwenden?", "Pourquoi utiliser une image arrière avant/après ?"),
    "what do the published styling images show?": ("¿Qué muestran las imágenes de estilismo publicadas?", "Was zeigen die veröffentlichten Styling-Bilder?", "Que montrent les images de style publiées ?"),
    "are the commercial terms confirmed?": ("¿Los términos comerciales están confirmados?", "Sind die Geschäftsbedingungen bestätigt?", "Les conditions commerciales sont-elles confirmées ?"),
    "can buyers request custom colours and packaging?": ("¿Los compradores pueden solicitar colores y empaques personalizados?", "Können Käufer individuelle Farben und Verpackungen anfragen?", "Les acheteurs peuvent-ils demander des couleurs et emballages personnalisés ?"),
    "can i choose several shades for a new range?": ("¿Puedo elegir varios tonos para una nueva gama?", "Kann ich mehrere Nuancen für eine neue Range wählen?", "Puis-je choisir plusieurs nuances pour une nouvelle gamme ?"),
    "are the 31 colours guaranteed to look identical on every product?": ("¿Se garantiza que los 31 tonos se vean idénticos en cada producto?", "Werden die 31 Nuancen auf jedem Produkt identisch aussehen?", "Les 31 nuances sont-elles garanties identiques sur chaque produit ?"),
    "are the packaging images finished customer orders?": ("¿Las imágenes de empaque son pedidos de clientes terminados?", "Sind die Verpackungsbilder fertige Kundenaufträge?", "Les images d'emballage sont-elles des commandes clients finies ?"),
    "can ds hair place my own logo on the packaging?": ("¿Puede ds hair poner mi propio logo en el empaque?", "Kann ds hair mein eigenes Logo auf die Verpackung bringen?", "Ds hair peut-il apposer mon propre logo sur l'emballage ?"),
    "can a small or new hair brand request private-label packaging?": ("¿Una marca de cabello pequeña o nueva puede solicitar empaque de marca privada?", "Kann eine kleine oder neue Haarmarke Private-Label-Verpackung anfragen?", "Une petite ou nouvelle marque capillaire peut-elle demander un emballage de marque privée ?"),
    "can packaging be approved before a repeat order?": ("¿Se puede aprobar el empaque antes de un pedido repetido?", "Kann Verpackung vor einer Wiederbestellung freigegeben werden?", "L'emballage peut-il être approuvé avant une commande répétée ?"),
    "do you publish a fixed packaging moq or price?": ("¿Publican un MOQ o precio fijo de empaque?", "Veröffentlichen Sie eine feste Verpackungs-MOQ oder einen Preis?", "Publiez-vous un MOQ ou prix d'emballage fixe ?"),
    "which logo files should i provide?": ("¿Qué archivos de logo debo proporcionar?", "Welche Logo-Dateien soll ich bereitstellen?", "Quels fichiers logo dois-je fournir ?"),
    "ds hair · global b2b": ("DS HAIR · GLOBAL B2B", "DS HAIR · GLOBAL B2B", "DS HAIR · GLOBAL B2B"),
    # ---- AEO additions: homepage FAQ, blog buyer-guide index, founder byline ----
    "the questions buyers ask first.": ('Las preguntas que hacen primero los compradores.', 'Die Fragen, die Käufer zuerst stellen.', 'Les questions que les acheteurs posent d’abord.'),
    "straight answers on what we supply, minimums, samples and timing. commercial terms are always confirmed in writing against your specification.": ('Respuestas directas sobre qué suministramos, mínimos, muestras y plazos. Las condiciones comerciales se confirman siempre por escrito según su especificación.', 'Klare Antworten zu Lieferumfang, Mindestmengen, Mustern und Zeitrahmen. Handelsbedingungen werden immer schriftlich gegen Ihre Spezifikation bestätigt.', 'Des réponses directes sur notre offre, les minimums, les échantillons et les délais. Les conditions commerciales sont toujours confirmées par écrit selon votre spécification.'),
    "read the full trade account faq": ('Ver las preguntas frecuentes de cuenta comercial', 'Alle Handelskonto-FAQ lesen', 'Lire la FAQ complète du compte professionnel'),
    "what does ds hair supply?": ('¿Qué suministra DS HAIR?', 'Was liefert DS HAIR?', 'Que fournit DS HAIR ?'),
    "wholesale human hair extensions, lace wigs, hair toppers, synthetic hairpieces and salon supplies, plus oem and private-label development for hair brands, distributors and salons. availability, moq, price and lead time are confirmed against your written specification.": ('Extensiones de pelo humano al por mayor, pelucas de encaje, toppers, complementos sintéticos y suministros de salón, además de desarrollo OEM y de marca privada para marcas, distribuidores y salones. Disponibilidad, MOQ, precio y plazo se confirman según su especificación escrita.', 'Echthaar-Extensions im Großhandel, Lace-Perücken, Topper, synthetische Haarteile und Salonbedarf sowie OEM- und Private-Label-Entwicklung für Marken, Distributoren und Salons. Verfügbarkeit, MOQ, Preis und Lieferzeit werden gegen Ihre schriftliche Spezifikation bestätigt.', 'Extensions en cheveux humains en gros, perruques lace, toppers, accessoires synthétiques et fournitures de salon, ainsi qu’un développement OEM et marque privée pour marques, distributeurs et salons. Disponibilité, MOQ, prix et délai sont confirmés selon votre spécification écrite.'),
    "what is your minimum order quantity?": ('¿Cuál es su cantidad mínima de pedido?', 'Wie hoch ist Ihre Mindestbestellmenge?', 'Quelle est votre quantité minimale de commande ?'),
    "moq is set per product, construction and whether the order is private-label. we confirm the exact minimum for your style and market during the specification review, and smaller development runs are often possible for new brands.": ('El MOQ se fija por producto, construcción y si el pedido es de marca privada. Confirmamos el mínimo exacto para su estilo y mercado durante la revisión de especificación, y a menudo son posibles tiradas de desarrollo más pequeñas para marcas nuevas.', 'Der MOQ wird pro Produkt, Konstruktion und danach festgelegt, ob der Auftrag Private Label ist. Wir bestätigen das genaue Minimum für Ihren Stil und Markt während der Spezifikationsprüfung; kleinere Entwicklungsmengen sind für neue Marken oft möglich.', 'Le MOQ est défini par produit, par construction et selon que la commande est en marque privée. Nous confirmons le minimum exact pour votre style et votre marché lors de la revue de spécification, et des séries de développement plus petites sont souvent possibles pour les nouvelles marques.'),
    "do you supply samples, and are they free?": ('¿Suministran muestras y son gratuitas?', 'Liefern Sie Muster, und sind sie kostenlos?', 'Fournissez-vous des échantillons, et sont-ils gratuits ?'),
    "yes, we supply samples, but they are not free. human-hair products are high-value, so samples are provided at sample price plus shipping at the buyer's cost. an approved sample becomes the reference that bulk production is measured against.": ('Sí, suministramos muestras, pero no son gratuitas. Los productos de pelo humano son de alto valor, así que las muestras se facilitan a precio de muestra más envío a cargo del comprador. Una muestra aprobada se convierte en la referencia con la que se mide la producción.', 'Ja, wir liefern Muster, aber sie sind nicht kostenlos. Echthaarprodukte sind hochwertig, daher werden Muster zum Musterpreis plus Versand zu Lasten des Käufers gestellt. Ein freigegebenes Muster wird zur Referenz, an der die Serienproduktion gemessen wird.', 'Oui, nous fournissons des échantillons, mais ils ne sont pas gratuits. Les produits en cheveux humains ont une valeur élevée : les échantillons sont fournis au prix échantillon plus l’expédition à la charge de l’acheteur. Un échantillon approuvé devient la référence de la production.'),
    "how long does sampling and production take?": ('¿Cuánto tardan las muestras y la producción?', 'Wie lange dauern Muster und Produktion?', 'Combien de temps prennent les échantillons et la production ?'),
    "sampling typically takes a few working days to a couple of weeks, depending on construction. production lead time is confirmed per order volume and stated in your written quotation. express sample shipments to the uk and eu usually take 3 to 5 working days.": ('Las muestras suelen tardar de unos días laborables a un par de semanas, según la construcción. El plazo de producción se confirma por volumen de pedido y se indica en su cotización escrita. Los envíos de muestra exprés al Reino Unido y la UE suelen tardar de 3 a 5 días laborables.', 'Muster dauern je nach Konstruktion in der Regel einige Arbeitstage bis zu zwei Wochen. Die Produktionszeit wird pro Auftragsvolumen bestätigt und im schriftlichen Angebot genannt. Express-Musterversand nach UK und EU dauert meist 3 bis 5 Arbeitstage.', 'Les échantillons prennent généralement de quelques jours ouvrés à deux semaines selon la construction. Le délai de production est confirmé par volume de commande et indiqué dans votre devis écrit. Les envois d’échantillons express vers le Royaume-Uni et l’UE prennent en général 3 à 5 jours ouvrés.'),
    "buyer guides": ('GUÍAS PARA COMPRADORES', 'KÄUFERLEITFÄDEN', 'GUIDES ACHETEURS'),
    "practical guides to sourcing hair at wholesale.": ('Guías prácticas para abastecerse de pelo al por mayor.', 'Praktische Leitfäden für den Hair-Einkauf im Großhandel.', 'Guides pratiques pour sourcer du cheveu en gros.'),
    "fifteen question-led guides covering specification, sampling, colour, packaging, lead times and market entry. each one answers a buyer question directly.": ('Quince guías basadas en preguntas que cubren especificación, muestras, color, embalaje, plazos y entrada al mercado. Cada una responde directamente a una pregunta de comprador.', 'Fünfzehn fragegeleitete Leitfäden zu Spezifikation, Mustern, Farbe, Verpackung, Lieferzeiten und Markteintritt. Jeder beantwortet eine Käuferfrage direkt.', 'Quinze guides construits autour de questions couvrant spécification, échantillons, couleur, emballage, délais et entrée sur le marché. Chacun répond directement à une question d’acheteur.'),
    "who writes this": ('QUIÉN ESCRIBE ESTO', 'WER SCHREIBT DIES', 'QUI ÉCRIT CE CONTENU'),
    "written by the founder, not a content team.": ('Escrito por la fundadora, no por un equipo de contenidos.', 'Von der Gründerin geschrieben, nicht von einem Content-Team.', 'Écrit par la fondatrice, pas par une équipe de contenu.'),
    "every buyer guide published here is written and reviewed against our own supply record.": ('Cada guía para compradores publicada aquí se escribe y revisa según nuestro propio historial de suministro.', 'Jeder hier veröffentlichte Käuferleitfaden wird gegen unseren eigenen Liefernachweis geschrieben und geprüft.', 'Chaque guide acheteurs publié ici est rédigé et vérifié à partir de notre propre historique d’approvisionnement.'),
    "in the trade since 2007": ('En el sector desde 2007', 'Seit 2007 im Geschäft', 'Dans le métier depuis 2007'),
    "caro founded the business and has worked in international hair sourcing since 2007, developing private-label and wholesale programmes for more than fifty hair brands across the uk and europe.": ('Caro fundó el negocio y trabaja en el abastecimiento internacional de pelo desde 2007, desarrollando programas de marca privada y venta al por mayor para más de cincuenta marcas de peluquería en el Reino Unido y Europa.', 'Caro gründete das Unternehmen und ist seit 2007 im internationalen Hair-Sourcing tätig; sie entwickelte Private-Label- und Großhandelsprogramme für mehr als fünfzig Hair-Marken in Großbritannien und Europa.', 'Caro a fondé l’entreprise et travaille dans le sourcing capillaire international depuis 2007, développant des programmes de marque privée et de gros pour plus de cinquante marques capillaires au Royaume-Uni et en Europe.'),
    "reviewed, not invented": ('Revisado, no inventado', 'Geprüft, nicht erfunden', 'Vérifié, pas inventé'),
    "where a commercial term is not confirmed for a specific product, the guide says so rather than publishing a number we cannot stand behind. commercial terms are always confirmed in writing against your specification.": ('Cuando una condición comercial no está confirmada para un producto concreto, la guía lo dice en lugar de publicar una cifra que no podemos respaldar. Las condiciones comerciales se confirman siempre por escrito según su especificación.', 'Ist eine Handelsbedingung für ein bestimmtes Produkt nicht bestätigt, sagt der Leitfaden das, statt eine Zahl zu veröffentlichen, für die wir nicht einstehen können. Handelsbedingungen werden immer schriftlich gegen Ihre Spezifikation bestätigt.', 'Lorsqu’une condition commerciale n’est pas confirmée pour un produit précis, le guide le dit plutôt que de publier un chiffre que nous ne pouvons pas assumer. Les conditions commerciales sont toujours confirmées par écrit selon votre spécification.'),
    # ---- Company-history corrections: hair products since 2008, company established 2012 ----
    "built through nearly two decades in international hair.": ('Construido durante casi dos décadas en cabello internacional.', 'Aufgebaut über fast zwei Jahrzehnte im internationalen Haarhandel.', 'Bâti sur près de deux décennies dans les cheveux internationaux.'),
    "hair products": ('PRODUCTOS CAPILARES', 'HAARPRODUKTE', 'PRODUITS CAPILLAIRES'),
    "the business entered the international hair-products industry.": ('El negocio entró en la industria internacional de productos capilares.', 'Das Unternehmen stieg in die internationale Haarproduktbranche ein.', "L'entreprise est entrée dans l'industrie internationale des produits capillaires."),
    "company established": ('EMPRESA CONSTITUIDA', 'UNTERNEHMEN GEGRÜNDET', 'SOCIÉTÉ CONSTITUÉE'),
    "supply relationships with professional buyers developed across the uk and europe.": ('Se desarrollaron relaciones de suministro con compradores profesionales en el Reino Unido y Europa.', 'Lieferbeziehungen zu professionellen Käufern in UK und Europa wurden aufgebaut.', 'Des relations de fourniture avec des acheteurs professionnels se sont développées au Royaume-Uni et en Europe.'),
    # ---- Company history: hair products since 2007, company established 2012 ----
    "hair-industry experience since 2007": ('Experiencia en la industria del cabello desde 2007', 'Haarbranchen-Erfahrung seit 2007', "Expérience de l'industrie capillaire depuis 2007"),
    "we entered the hair-products industry in 2007. the operating company behind ds hair, hubei deshang industry & trade co., ltd., was established in 2012. manufacturing knowledge and long-term export relationships followed, including professional buyers across europe and other overseas markets.": ('Entramos en la industria de productos capilares en 2007. La empresa operadora detrás de DS HAIR, HuBei DeShang Industry & Trade Co., Ltd., se constituyó en 2012. Siguió el conocimiento de fabricación y relaciones de exportación a largo plazo, incluyendo compradores profesionales en Europa y otros mercados extranjeros.', 'Wir sind 2007 in die Haarproduktbranche eingestiegen. Das operative Unternehmen hinter DS HAIR, HuBei DeShang Industry & Trade Co., Ltd., wurde 2012 gegründet. Fertigungswissen und langfristige Exportbeziehungen folgten, darunter Fachkäufer in Europa und anderen Überseemärkten.', "Nous sommes entrés dans l'industrie des produits capillaires en 2007. La société d'exploitation derrière DS HAIR, HuBei DeShang Industry & Trade Co., Ltd., a été constituée en 2012. Des connaissances en fabrication et des relations d'export à long terme ont suivi, avec des acheteurs professionnels en Europe et sur d'autres marchés outre-mer."),
    "hubei deshang industry & trade co., ltd., the operating company behind ds hair, was founded.": ('Se fundó HuBei DeShang Industry & Trade Co., Ltd., la empresa operadora detrás de DS HAIR.', 'HuBei DeShang Industry & Trade Co., Ltd., das operative Unternehmen hinter DS HAIR, wurde gegründet.', "HuBei DeShang Industry & Trade Co., Ltd., la société d'exploitation derrière DS HAIR, a été fondée."),
    "19 yrs": ('19 años', '19 Jahre', '19 ans'),
    "manufacturing since 2007": ('de fabricación desde 2007', 'Fertigung seit 2007', 'de fabrication depuis 2007'),
}
...
def main():
    ...
    lines.append('    "customization.html", "hair-colour-chart-custom-packaging.html",')
    lines.append('    "synthetic-25-inch-straight-wrap-around-ponytail.html",')
    lines.append("]")
    lines.append("")
