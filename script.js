...
if(nav){
  ...
  nav.innerHTML=`
    ...
    <div class="nav-dropdown">
      <button class="nav-trigger${active('products.html','human-hair-extensions.html','clip-in-human-hair-extensions.html','tape-in-human-hair-extensions.html','k-tip-human-hair-extensions.html','genius-weft-human-hair-extensions.html','machine-weft-human-hair-extensions.html','nano-ring-human-hair-extensions.html','human-hair-wigs-toppers.html','synthetic-wigs-hairpieces.html','salon-supplies.html')}" type="button" aria-expanded="false">Collections <svg viewBox="0 0 12 8" aria-hidden="true"><path d="M1 1l5 5 5-5" fill="none" stroke="currentColor"/></svg></button>
      <div class="mega-menu mega-menu-collections">
        <div class="mega-group"><strong>Human Hair Extensions</strong><a href="clip-in-human-hair-extensions.html">Clip-in</a><a href="tape-in-human-hair-extensions.html">Tape-in</a><a href="k-tip-human-hair-extensions.html">K-tip</a><a href="genius-weft-human-hair-extensions.html">Genius Weft</a><a href="machine-weft-human-hair-extensions.html">Machine Weft</a><a href="nano-ring-human-hair-extensions.html">Nano Ring</a></div>
